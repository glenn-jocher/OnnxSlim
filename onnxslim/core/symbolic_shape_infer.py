...
class SymbolicShapeInference:
    ...
    def _get_int_or_float_values(self, node, broadcast=False, allow_float_values=False):
        ...
        def int_or_float(value, allow_float_values):
            """Converts a value to an integer unless it has precision loss and allow_float_values is True."""
    ...
    def _infer_Slice(self, node):  # noqa: N802
        ...
        def flatten_min(expr):
            """Returns a list of expressions split by `min` operation for inequalities proof, or `[expr]` if `expr`
            lacks a `min` subexpression.
            """
